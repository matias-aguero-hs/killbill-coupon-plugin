...
public class TestChangeCouponServlet extends Mockito {
    ...
    @Test
    public void testChangeCouponServletOK() throws Exception {
    ...
    @Test
    public void testChangeCouponServletWithNullRequest() throws Exception {
        StringWriter stringWriter = new StringWriter();
        PrintWriter writer = new PrintWriter(stringWriter);
        UUID randomTenantId = UUID.randomUUID();
    ...
    @Test
    public void testChangeCouponServletWithNullCouponUpdated() throws Exception {
        StringWriter stringWriter = new StringWriter();
        PrintWriter writer = new PrintWriter(stringWriter);
        UUID randomTenantId = UUID.randomUUID();
        Coupon coupon = buildSuccessfulCoupon(randomTenantId);
    ...
    @Test
    public void testChangeCouponServletSQLException() throws Exception {
        StringWriter stringWriter = new StringWriter();
        PrintWriter writer = new PrintWriter(stringWriter);
        UUID randomTenantId = UUID.randomUUID();
        Coupon coupon = buildSuccessfulCoupon(randomTenantId);
    ...
    @Test
    public void testChangeCouponServletApiException() throws Exception {
        StringWriter stringWriter = new StringWriter();
        PrintWriter writer = new PrintWriter(stringWriter);
