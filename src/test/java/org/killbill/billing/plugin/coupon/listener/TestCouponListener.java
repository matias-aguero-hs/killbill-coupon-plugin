...
public class TestCouponListener extends Mockito {
    ...
    public void testInvoiceItemCreation() throws Exception {
        ...
        CouponsAppliedRecord couponApplied = new CouponsAppliedRecord(null, COUPON_CODE,
                                                               subscriptionId.toString(),
                                                               account.getId().toString(),
                                                               tenantId.toString());

        CouponsRecord coupon = new CouponsRecord(null, COUPON_CODE, "name", "percentage", 5.0, tenantId.toString());
